...
const telegramIconSource = `"use client";
...
const airplaneIconSource = `"use client";
...
const arrowDown01IconSource = `"use client";
...
const terminalIconSource = `"use client";
...
const passportIconSource = `"use client";
...
const rupeeIconSource = `"use client";
...
const infoCircleIconSource = `"use client";
...
export const hoverlyIcons: HoverlyIconRecord[] = [
  {
    slug: "arrow-down-0-1-icon",
    name: "Arrow Down 0 1 Icon",
    category: "Arrows",
    description:
      "A descending sort indicator with fade-and-draw reveal and polished 0/1 swap motion.",
    tags: ["arrow", "sort", "descending", "numbers", "ui", "arrows"],
    componentName: "ArrowDown01Icon",
    importPath: "@/icons/arrow-down-0-1-icon",
    sourceCode: arrowDown01IconSource,
    registryUrl: arrowDown01RegistryUrl,
    cliCommands: [
      {
        label: "npm",
        command: `npx shadcn@latest add ${arrowDown01RegistryUrl}`,
      },
      {
        label: "pnpm",
        command: `pnpm dlx shadcn@latest add ${arrowDown01RegistryUrl}`,
      },
      {
        label: "yarn",
        command: `yarn shadcn@latest add ${arrowDown01RegistryUrl}`,
      },
      {
        label: "bun",
        command: `bunx --bun shadcn@latest add ${arrowDown01RegistryUrl}`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    category: "Arrows",
    description:
      "A dynamic airplane mark with fade-and-draw takeoff motion and trailing wind streaks.",
    tags: ["airplane", "flight", "travel", "navigation", "motion", "wind"],
    componentName: "AirplaneIcon",
    importPath: "@/icons/airplane-icon",
    sourceCode: airplaneIconSource,
    registryUrl: airplaneRegistryUrl,
    cliCommands: [
      {
        label: "npm",
        command: `npx shadcn@latest add ${airplaneRegistryUrl}`,
      },
      {
        label: "pnpm",
        command: `pnpm dlx shadcn@latest add ${airplaneRegistryUrl}`,
      },
      {
        label: "yarn",
        command: `yarn shadcn@latest add ${airplaneRegistryUrl}`,
      },
      {
        label: "bun",
        command: `bunx --bun shadcn@latest add ${airplaneRegistryUrl}`,
      },
    ],
  },
  {
    ...
    category: "UI",
    description:
      "An activity pulse icon with a clean draw-on hover animation for monitoring and analytics UI.",
    tags: ["activity", "pulse", "monitoring", "analytics", "ui", "status"],
    componentName: "ActivityIcon",
    importPath: "@/icons/activity-icon",
...
export { ActivityIcon };
`,
    registryUrl: activityRegistryUrl,
    cliCommands: [
      {
        label: "npm",
        command: `npx shadcn@latest add ${activityRegistryUrl}`,
      },
      {
        label: "pnpm",
        command: `pnpm dlx shadcn@latest add ${activityRegistryUrl}`,
      },
      {
        label: "yarn",
        command: `yarn shadcn@latest add ${activityRegistryUrl}`,
      },
      {
        label: "bun",
        command: `bunx --bun shadcn@latest add ${activityRegistryUrl}`,
      },
    ],
  },
  {
  ...
  {
    slug: "info-circle-icon",
    name: "Info Circle Icon",
    category: "UI",
    description:
      "A friendly info-circle icon with staged reveal animation for help and guidance states.",
    tags: ["info", "help", "hint", "tooltip", "ui", "status"],
    componentName: "InfoCircleIcon",
    importPath: "@/icons/info-circle-icon",
    sourceCode: infoCircleIconSource,
    registryUrl: infoCircleRegistryUrl,
    cliCommands: [
      {
        label: "npm",
        command: `npx shadcn@latest add ${infoCircleRegistryUrl}`,
      },
      {
        label: "pnpm",
        command: `pnpm dlx shadcn@latest add ${infoCircleRegistryUrl}`,
      },
      {
        label: "yarn",
        command: `yarn shadcn@latest add ${infoCircleRegistryUrl}`,
      },
      {
        label: "bun",
        command: `bunx --bun shadcn@latest add ${infoCircleRegistryUrl}`,
      },
    ],
  },
...
`,
  ...
  },
  {
    ...
    category: "UI",
    description:
      "A brain + circuit glyph with staged trace drawing and subtle pulse loop for AI and automation UI.",
    tags: ["brain", "circuit", "ai", "neural", "automation", "ui", "tech"],
    componentName: "BrainCircuitIcon",
    importPath: "@/icons/brain-circuit-icon",
    sourceCode: `"use client";
...
`,
    registryUrl: brainCircuitRegistryUrl,
    cliCommands: [
      {
        label: "npm",
        command: `npx shadcn@latest add ${brainCircuitRegistryUrl}`,
      },
      {
        label: "pnpm",
        command: `pnpm dlx shadcn@latest add ${brainCircuitRegistryUrl}`,
      },
      {
        label: "yarn",
        command: `yarn shadcn@latest add ${brainCircuitRegistryUrl}`,
      },
      {
        label: "bun",
        command: `bunx --bun shadcn@latest add ${brainCircuitRegistryUrl}`,
      },
    ],
  },
  {
    ...
    category: "UI",
    description:
      "A crisp terminal prompt icon with a chevron draw-in and blinking cursor loop.",
    tags: ["terminal", "cli", "command", "prompt", "developer", "ui"],
    componentName: "TerminalIcon",
    importPath: "@/icons/terminal-icon",
    sourceCode: terminalIconSource,
    registryUrl: terminalRegistryUrl,
    cliCommands: [
      {
        label: "npm",
        command: `npx shadcn@latest add ${terminalRegistryUrl}`,
      },
      {
        label: "pnpm",
        command: `pnpm dlx shadcn@latest add ${terminalRegistryUrl}`,
      },
      {
        label: "yarn",
        command: `yarn shadcn@latest add ${terminalRegistryUrl}`,
      },
      {
        label: "bun",
        command: `bunx --bun shadcn@latest add ${terminalRegistryUrl}`,
      },
    ],
  },
  {
    ...
    category: "UI",
    description:
      "A passport silhouette with flap glide-in and globe draw animation for travel and identity UI.",
    tags: ["passport", "travel", "document", "identity", "ui"],
    componentName: "PassportIcon",
    importPath: "@/icons/passport-icon",
    sourceCode: passportIconSource,
    registryUrl: passportRegistryUrl,
    cliCommands: [
      {
        label: "npm",
        command: `npx shadcn@latest add ${passportRegistryUrl}`,
      },
      {
        label: "pnpm",
        command: `pnpm dlx shadcn@latest add ${passportRegistryUrl}`,
      },
      {
        label: "yarn",
        command: `yarn shadcn@latest add ${passportRegistryUrl}`,
      },
      {
        label: "bun",
        command: `bunx --bun shadcn@latest add ${passportRegistryUrl}`,
      },
    ],
  },
  {
    ...
    category: "UI",
    description:
      "A rupee currency symbol with a crisp draw-on reveal and subtle hover breathing.",
    tags: ["rupee", "currency", "money", "payment", "india", "ui"],
    componentName: "CurrencyRupeeIcon",
    importPath: "@/icons/rupee-icon",
    sourceCode: rupeeIconSource,
    registryUrl: rupeeRegistryUrl,
    cliCommands: [
      {
        label: "npm",
        command: `npx shadcn@latest add ${rupeeRegistryUrl}`,
      },
      {
        label: "pnpm",
        command: `pnpm dlx shadcn@latest add ${rupeeRegistryUrl}`,
      },
      {
        label: "yarn",
        command: `yarn shadcn@latest add ${rupeeRegistryUrl}`,
      },
      {
        label: "bun",
        command: `bunx --bun shadcn@latest add ${rupeeRegistryUrl}`,
      },
    ],
  },
  {
...
`,
  ...
  },
  {
    ...
    category: "Social",
    description:
      "A Telegram paper-plane icon with directional flight motion and fade transitions on hover.",
    tags: ["telegram", "social", "brand", "logo", "messaging", "chat"],
    componentName: "TelegramIcon",
    importPath: "@/icons/telegram-icon",
    sourceCode: telegramIconSource,
    registryUrl: telegramRegistryUrl,
    cliCommands: [
      {
        label: "npm",
        command: `npx shadcn@latest add ${telegramRegistryUrl}`,
      },
      {
        label: "pnpm",
        command: `pnpm dlx shadcn@latest add ${telegramRegistryUrl}`,
      },
      {
        label: "yarn",
        command: `yarn shadcn@latest add ${telegramRegistryUrl}`,
      },
      {
        label: "bun",
        command: `bunx --bun shadcn@latest add ${telegramRegistryUrl}`,
      },
    ],
  },
  {

  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-24">
      <motion.h2
        ...
        viewport={{ once: true }}
        className="mb-10 font-heading text-3xl font-medium text-white"
      >
        Features
      </motion.h2>
  ...
  return (
    ...
    >
      ...
      <div className="relative h-full w-full overflow-hidden">
        {component}
        <div className="pointer-events-none absolute inset-0 bg-linear-to-b from-transparent via-black/20 to-black/90" />
...
function OpenSourceVisual() {
  return (
    <div className="relative h-full w-full bg-[radial-gradient(circle_at_top_left,rgba(18,194,233,0.16),transparent_35%),linear-gradient(135deg,#111217,#161823)] p-6">
      <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.035)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.035)_1px,transparent_1px)] bg-[size:38px_38px] opacity-30" />
      <div className="absolute left-6 top-6 rounded-full border border-white/10 bg-white/6 px-3 py-1 text-[11px] tracking-[0.2em] text-white/60 uppercase">
        source
      </div>
      <div className="absolute inset-x-6 top-20 rounded-[1.25rem] border border-white/10 bg-black/30 p-4 shadow-[0_18px_60px_rgba(0,0,0,0.28)]">
...
function CustomizeVisual() {
  return (
    <div className="relative h-full w-full bg-[linear-gradient(135deg,#0f1117,#171b23)] p-6">
      <div className="absolute inset-y-0 left-[52%] w-px bg-white/8" />
      <div className="absolute left-6 top-6 right-[52%] rounded-[1.25rem] border border-white/10 bg-black/26 p-4">
        <div className="mb-4 text-[11px] tracking-[0.2em] text-white/42 uppercase">
          props
        </div>
...
function RegistryVisual() {
  ...
  return (
    <div className="relative h-full w-full bg-[linear-gradient(160deg,#101116,#17141a)] p-6">
      <div className="absolute inset-x-6 top-8 overflow-hidden rounded-[1.4rem] border border-white/10 bg-[#121012]">
        ...
        <div className="px-5 py-6 font-mono text-[15px] text-[#d8deea]">
...
function MotionVisual() {
  return (
    <div className="relative h-full w-full bg-[radial-gradient(circle_at_top,rgba(18,194,233,0.16),transparent_30%),linear-gradient(160deg,#0f1117,#151822)] p-6">
      <motion.div
        animate={{ y: [0, -8, 0] }}

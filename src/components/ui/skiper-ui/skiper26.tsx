...
export const ThemeToggleButton = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-9 cursor-pointer rounded-full p-0 transition-all duration-300 active:scale-95",
    ...
    >
      ...
      >
        <motion.circle
          ...
          fill="currentColor"
          stroke="none"
          animate={{ scale: isDark ? 0.55 : 1, opacity: isDark ? 0 : 1 }}
        ...
        <motion.g
          ...
          transition={{ ease: "easeInOut", duration: 0.35 }}
        >
          <path d="M12 2.5V5" strokeWidth="1.8" />
          <path d="M12 19V21.5" strokeWidth="1.8" />
          <path d="M2.5 12H5" strokeWidth="1.8" />
          <path d="M19 12H21.5" strokeWidth="1.8" />
          <path d="M5.8 5.8L7.5 7.5" strokeWidth="1.8" />
          <path d="M16.5 16.5L18.2 18.2" strokeWidth="1.8" />
          <path d="M5.8 18.2L7.5 16.5" strokeWidth="1.8" />
          <path d="M16.5 7.5L18.2 5.8" strokeWidth="1.8" />
        </motion.g>
        ...
        <motion.path
          ...
          fill="currentColor"
          stroke="none"
          animate={{ scale: isDark ? 1 : 0.65, opacity: isDark ? 1 : 0 }}
          transition={{ ease: "easeInOut", duration: 0.35 }}
        />
      </svg>
    </button>
